...
export const CardContainer = ({
  ...
  return (
    <MouseEnterContext.Provider value={[isMouseEntered, setIsMouseEntered]}>
      <div
        className={cn(
          "py-20 flex items-center justify-between",
          containerClassName
        )}
        style={{
          perspective: "1000px",
...
export function TSCardInstance({ className }: { className?: string }) {
  return (
    <>
      <div className={className}>
        ...
        <CardDescription>
          Built with MongoDB, Node.js, React, and Express, seamlessly
          integrating Google Gemini and FastAPI for a powerful, scalable tech
          stack. A modern solution combining flexibility, speed, and
          intelligence.
        </CardDescription>
      </div>
    </>
...
export const CardTitle = ({
  ...
  return (
    <h3 className={cn("text-lg font-semibold text-gray-800 py-2", className)}>
      {children}
    </h3>
  );
};
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn("text-md font-normal text-neutral-600 max-w-sm", className)}
    >
      {children}
    </p>
  );
...
export const InfoDescription = ({
  ...
  return (
    <p className={cn("text-md font-normal text-white-600", className)}>
      {children}
    </p>
  );
};
...
export const Pointers = () => {
  return (
    <ul>
      <li>
        <strong className="text-white underline underline-offset-1">
          MERN Stack (MongoDB, Express, React, Node.js):
        </strong>
        <ul className="list-disc">
          <li>
            Seamless JavaScript integration across frontend and backend for
            efficient development.
          </li>
          <li>
            React powers interactive chat window and movie pages, creating a
            user-friendly interface.
          </li>
          <li>
            MongoDB and Express handle user authentication, data storage, and
            API routing, ensuring smooth communication between frontend and
            backend.
          </li>
          <li>
            Enables rapid development, scalability, and flexibility throughout
            the project.
          </li>
        </ul>
      </li>
      ...
      <li>
        <strong className="text-white underline underline-offset-1">
          Google Gemini for Chitra (AI Movie Bot):
        </strong>
        <ul className="list-disc">
          <li>
            Utilizes advanced language model capabilities for personalized movie
            recommendations and engaging movie discussions.
          </li>
        </ul>
      </li>
      <br></br>
      <li>
        <strong className="text-white underline underline-offset-1">Backend with FastAPI:</strong>
        <ul className="list-disc">
          <li>
            Efficiently processes user requests and interacts with multiple data
            sources (SQLite, ChromaDB, TMDB, IMDB) using a Retrieval-Augmented
            Generation (RAG) approach.
          </li>
          <li>
            Integration of Text-to-SQL functionality ensures precise movie
            recommendations.
          </li>
        </ul>
      </li>
      <br></br>
      <li>
        <strong className="text-white underline underline-offset-1">Interactive Features:</strong>
        <ul className="list-disc">
          <li>
            Generates conversation analysis reports (PDFs) delivered via Celery
            tasks and MailHog for personalized user experiences.
          </li>
        </ul>
      </li>
      <br></br>
      <li>
        <strong className="text-white underline underline-offset-1">Full Stack Integration:</strong>
        <ul className="list-disc">
          <li>
            Combines MERN stack, Gemini's natural language understanding, and
            FastAPI for a responsive, intelligent platform for movie lovers.
          </li>
          <li>
            Allows users to explore, receive tailored recommendations, and
