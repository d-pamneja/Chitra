    ...
    return (
        <div className="h-[1300px] flex items-center justify-center text-white mb-[-350px]">
            ...
            >
                <div
                    id="slider"
                    className="animate-[autoRunCarousel_20s_linear_infinite] absolute top-10 left-[calc(50%-100px)] w-[200px] h-[250px] z-20"
                    style={{
                ...
                >
                    <h1 
                        className="relative font-icaRubrik text-[4em] ml-[150px] leading-12 z-50"
